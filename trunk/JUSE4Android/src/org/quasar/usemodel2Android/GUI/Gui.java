...
import org.quasar.usemodel2Android.Prototype_CodeGeneration;
...
//		processBuilder.redirectOutput(Redirect.INHERIT);
		...
		btnGenerate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				final String arg4_user = user.getText();
				final String arg5_pass = pass.getText();
				final String arg6_port = port.getText();
