...
public class AssociationInfo
{
	...
	***********************************************************/
	...
	{
		return (!theClass.parents().isEmpty() && !theClass.associations().contains(ass)) ? associationBaseAncestor(theClass.parents().iterator().next(), ass) : theClass;
	}
	
	/***********************************************************
	 * same as getAssociationsInfo(MClass theClass) but works with all associations (also inherited associations)
	 * getSource not tested but very usefull when using getTarget 
	 * with this method we can rapidly get all the possible targets of a sub-class ;)
	 * @param theClass
	 * @return 
	 ***********************************************************/
